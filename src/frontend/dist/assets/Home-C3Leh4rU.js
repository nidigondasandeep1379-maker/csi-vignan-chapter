import { j as jsxRuntimeExports, r as reactExports, u as useInternetIdentity, a as useRouterState, L as Link, S as Skeleton } from "./index-DMe-1VHT.js";
import { c as createLucideIcon, B as Button } from "./button-DBRJMU4i.js";
import { M as Mail } from "./mail-B7Nrb0BG.js";
import { C as ChevronRight, M as Menu, U as Users } from "./users-EE9Ce7qR.js";
import { X } from "./index-D8jkdHVW.js";
import { L as Label, I as Input } from "./label-ouO4IPI4.js";
import { T as Textarea, C as ChevronDown } from "./textarea-Dyo7P4ma.js";
import { u as useEvents } from "./useEvents-BqfivaJz.js";
import { C as Calendar } from "./calendar-Cc1g2emD.js";
import { u as useGalleryImages } from "./useGalleryImages-BqerALEb.js";
import { u as useLeadershipTeam, a as useCommitteeMembers } from "./useTeamMembers-C6RM5ib3.js";
...
const CalendarX = createLucideIcon("calendar-x", __iconNode$d);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-card border-t border-border/60", "data-ocid": "footer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-7xl mx-auto px-4 md:px-6 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-lg mb-1", children: "CSI Student Chapter" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4 leading-relaxed", children: "Computer Society of India — Vignan Foundation for Science, Technology & Research University" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-4 w-4 mt-0.5 text-accent flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Vadlamudi, Guntur District, Andhra Pradesh, India — 522 213" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 text-accent flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "mailto:csi@vignan.ac.in",
                className: "hover:text-accent transition-colors duration-200",
                children: "csi@vignan.ac.in"
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 mt-5", children: SOCIAL_LINKS.map(({ label, href, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href,
            "aria-label": label,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-3 md:col-start-7", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-section-label mb-4 text-muted-foreground", children: "Quick Links" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-3 md:col-start-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-section-label mb-4 text-muted-foreground", children: "About CSI" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-3", children: "CSI is a premier professional body dedicated to advancing computing science and IT across India." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border/40 px-4 md:px-6 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "© ",
        year,
        " CSI Student Chapter, Vignan University. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      "data-ocid": "navbar",
      className: `fixed top-0 left-0 right-0 z-50 transition-smooth ${scrolled ? "bg-card/95 backdrop-blur-md nav-shadow" : "bg-card/80 backdrop-blur-sm border-b border-border/50"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "container flex h-16 items-center justify-between max-w-7xl mx-auto px-4 md:px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:block min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold font-display text-foreground leading-tight truncate", children: "CSI Student Chapter" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground truncate leading-tight", children: "Vignan University · Hyderabad" })
                ] })
              ]
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-3", children: [
            identity ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                variant: "outline",
                size: "sm",
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-card border-t border-border px-4 pb-4 pt-2 animate-fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => handleNavClick(link.href),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-border flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin", onClick: () => setMobileOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "outline",
                size: "sm",
...
function Layout({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: `flex-1 pt-16 ${className}`, children }),
...
const GOALS = [
  {
    ...
    description: "Organizing workshops, hackathons, and seminars to sharpen students' technical skills."
  },
  {
    icon: Users,
    title: "Community Building",
    description: "Creating a collaborative network of tech enthusiasts, mentors, and industry professionals."
  },
  {
    icon: Globe,
    title: "Industry Connect",
    description: "Bridging the gap between academia and industry through guest lectures and internship drives."
  }
];
const HIGHLIGHTS = [
...
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4 md:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-section-label mb-3", children: "Who We Are" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-section-heading text-foreground mb-4", children: [
                "About ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold-gradient", children: "CSI Vignan" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "The Computer Society of India (CSI) Student Chapter at Vignan University is a premier student-run organization dedicated to advancing computer science education and professional development." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              transition: { duration: 0.55 },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-6", children: "Founded under the umbrella of the Computer Society of India — the country's first and largest professional body in the field of IT — our chapter brings together passionate students, faculty, and industry experts to foster a culture of innovation and lifelong learning." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-8", children: "From cutting-edge workshops and hackathons to national-level competitions and community projects, CSI Vignan is where technology meets opportunity." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: HIGHLIGHTS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 mt-0.5 text-accent flex-shrink-0" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              className: "relative",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl overflow-hidden border border-border/60 shadow-2xl", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-5 left-5 right-5 bg-card/90 backdrop-blur-sm rounded-xl p-4 border border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                        src: "/assets/csi-logo.png",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-foreground font-display", children: "Affiliated with CSI India" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "National body since 1965 · 500+ chapters" })
                    ] })
                  ] }) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, oklch(0.72 0.15 75), transparent)"
                    },
                    "aria-hidden": "true"
                  }
                )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: GOALS.map((goal, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 20 },
            whileInView: { opacity: 1, y: 0 },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(goal.icon, { className: "h-5 w-5 text-accent" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-2", children: goal.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: goal.description })
            ]
          },
          goal.title
        )) })
...
function ContactSection() {
  ...
  const isValid = form.name.trim().length > 0 && form.email.includes("@") && form.message.trim().length > 10;
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4 md:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-section-label mb-3", children: "Get in Touch" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-section-heading text-foreground mb-4", children: [
                "Contact ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold-gradient", children: "Us" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto text-sm leading-relaxed", children: "Have a question, collaboration idea, or just want to say hello? We'd love to hear from you." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                INFO_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: "bg-card border border-border/60 rounded-2xl p-5 flex items-start gap-4",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-accent/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "h-4 w-4 text-accent" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold tracking-wide uppercase text-muted-foreground mb-1", children: item.label }),
                        ...
                        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground whitespace-pre-line", children: item.value })
                      ] })
                    ]
                  },
                  item.label
                )),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border/60 rounded-2xl overflow-hidden h-40 flex items-center justify-center relative", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "absolute inset-0 opacity-10",
                      style: {
                        backgroundImage: "radial-gradient(circle, oklch(0.72 0.15 75) 1px, transparent 1px)",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center relative z-10", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-8 w-8 text-accent mx-auto mb-1 opacity-60" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Vignan University, Vadlamudi" })
                  ] })
                ] })
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border/60 rounded-2xl p-7 md:p-9", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-accent/10 flex items-center justify-center mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-8 w-8 text-accent" }) }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed max-w-xs", children: [
                      ...
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-medium", children: form.email }),
                      "."
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                ...
                "form",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-xl mb-1", children: "Send us a Message" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-5", children: "All fields marked are required." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "contact-name", className: "text-sm", children: [
                          "Full Name ",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        ...
                        children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-4 w-4 rounded-full border-2 border-accent-foreground/30 border-t-accent-foreground animate-spin" }),
                          "Sending…"
...
function EventCard({ event, index }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.article,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 bg-gradient-to-r from-accent/60 via-accent to-accent/40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex flex-col flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge-gold", children: CATEGORY_LABELS[event.category] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-lg mb-2 leading-snug line-clamp-2", children: event.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-4 line-clamp-3 flex-1", children: event.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-3.5 w-3.5 text-accent flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatDate(event.date) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3.5 w-3.5 text-accent flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: event.venue })
            ] }),
            event.maxAttendees && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-3.5 w-3.5 text-accent flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "Up to ",
                event.maxAttendees,
                " attendees"
          ...
          event.registrationLink && event.status === "upcoming" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  children: [
                    "Register Now",
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "ml-1.5 h-3.5 w-3.5" })
                  ]
                }
              )
            }
...
function EventsSkeletons() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: [1, 2, 3].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4 md:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-section-label mb-3", children: "What's Happening" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-section-heading text-foreground", children: [
                  "Upcoming ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold-gradient", children: "Events" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-sm text-sm leading-relaxed md:text-right", children: "Stay updated with our latest workshops, hackathons, seminars, and competitions." })
            ]
          }
        ),
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(EventsSkeletons, {}) : !events || events.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0 },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarX, { className: "h-12 w-12 text-muted-foreground/50 mx-auto mb-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-2", children: "No events yet" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Check back soon — exciting events are being planned!" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: events.map((event, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(EventCard, { event, index }, event.id)) })
      ] })
    }
  );
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card px-5 py-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: image.caption }),
                image.event && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: image.event })
              ] })
            ]
          },
          activeIndex
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-card border border-border text-xs text-muted-foreground", children: [
          activeIndex + 1,
          " / ",
          images.length
        ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.button,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-background/0 group-hover:bg-background/50 transition-colors duration-300 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ZoomIn, { className: "h-8 w-8 text-foreground opacity-0 group-hover:opacity-100 transition-opacity duration-200" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background/80 to-transparent p-3 translate-y-full group-hover:translate-y-0 transition-transform duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground font-medium line-clamp-1", children: image.caption }) })
      ]
    }
  );
}
function GallerySection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4 md:px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, y: 20 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-section-label mb-3", children: "Captured Moments" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-section-heading text-foreground mb-4", children: [
                  "Community ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold-gradient", children: "Gallery" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto text-sm leading-relaxed", children: "Highlights from our events, workshops, hackathons, and community gatherings." })
              ]
            }
          ),
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4", children: [1, 2, 3, 4, 5, 6, 7, 8].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "aspect-square rounded-xl" }, n)) }) : !images || images.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0 },
              whileInView: { opacity: 1 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Images, { className: "h-12 w-12 text-muted-foreground/50 mx-auto mb-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-2", children: "Gallery coming soon" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Photos from our events will appear here." })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4", children: images.map((image, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            GalleryThumb,
            {
              image,
              index,
        ...
        lightboxIndex !== null && images && images.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          LightboxModal,
          {
            images,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 container max-w-6xl mx-auto px-4 md:px-6 flex flex-col items-center text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, y: -20 },
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-12 md:h-16 bg-accent/30", "aria-hidden": "true" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: "/assets/college-logo.png",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h1,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "CSI Student" }),
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold-gradient", children: "Chapter" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.p,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent/70", children: " · " }),
                "Hyderabad"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.p,
            {
              ...
              children: "Empowering students through technology, innovation, and community. Join India's premier computing society."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl md:text-3xl font-bold font-display text-gold-gradient", children: stat.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs md:text-sm text-muted-foreground mt-1", children: stat.label })
              ] }, stat.label))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.button,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-5 w-5 animate-bounce" })
            ]
          }
        )
      ]
...
function MemberAvatar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: `${iconClass} text-muted-foreground/50` })
    }
  );
}
function LeadershipCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-accent to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MemberAvatar, { member, size: "lg" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-base leading-tight mb-1", children: member.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge-gold mb-2", children: member.roleLabel }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1", children: member.department }),
        member.year && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/70 mb-3", children: member.year }),
        member.bio && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed mb-3 line-clamp-2", children: member.bio }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-auto", children: [
          member.email && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
          ...
          member.linkedIn && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              className: "w-8 h-8 rounded-lg bg-muted hover:bg-accent/10 flex items-center justify-center text-muted-foreground hover:text-accent transition-smooth",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "h-3.5 w-3.5" })
            }
          )
        ] })
      ]
...
function CommitteeMemberCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MemberAvatar, { member, size: "sm" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-foreground text-sm truncate", children: member.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-accent truncate", children: member.roleLabel }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground truncate", children: member.department }),
          member.year && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground/60", children: member.year })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 flex-shrink-0", children: [
          member.email && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-3 w-3" })
            }
          ),
          member.linkedIn && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              className: "w-7 h-7 rounded-md bg-muted hover:bg-accent/10 flex items-center justify-center text-muted-foreground hover:text-accent transition-smooth",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "h-3 w-3" })
            }
          )
        ] })
      ]
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4 md:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            className: "text-center mb-14",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-section-label mb-3", children: "The People Behind It" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-section-heading text-foreground mb-4", children: [
                "Meet the ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold-gradient", children: "Team" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto text-sm leading-relaxed", children: "Our dedicated team of 17 members drives innovation, organises events, and builds the CSI Vignan community." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h3,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 h-px bg-border/60" }),
                "Leadership Team",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 h-px bg-border/60" })
              ]
            }
          ),
          leadLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-5", children: [1, 2, 3, 4, 5, 6].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "bg-card rounded-2xl p-5 space-y-3 flex flex-col items-center",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24 w-24 rounded-full" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-3/4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-20 rounded-full" })
              ]
            },
            n
          )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-5", children: (leadership ?? []).map((member, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(LeadershipCard, { member, index }, member.id)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h3,
          ...
          commLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4", children: [1, 2, 3, 4, 5, 6, 7, 8].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "bg-card/60 border border-border/50 rounded-xl p-4 flex items-center gap-3",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 w-16 rounded-full flex-shrink-0" }),
            ...
            n
          )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4", children: (committee ?? []).map((member, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            CommitteeMemberCard,
            {
              member,
              index
